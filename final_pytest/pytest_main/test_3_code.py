...
work_directory = os.path.join(base_path_concat,'3_code_validation')
...
xml_file_path = work_directory + "/xml_files_for_3_Code Validation"
filename_for_csv_with_results= '3_code_validation_testing_csv_results'
