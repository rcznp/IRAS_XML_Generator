...
work_directory = os.path.join(base_path_concat,'2_Conditional_Validation')
...
xml_file_path = work_directory + "/xml_files_for_2_Conditional Input Validation"
filename_for_csv_with_results= '2_condtional_testing_csv_results'
