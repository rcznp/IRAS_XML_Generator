...
work_directory = os.path.join(base_path_concat,'5_Record_Validation')
...
xml_file_path = work_directory + "/xml_files_for_5_Record Validation"
filename_for_csv_with_results = '5_Record_validation_testing_csv_results'
